//
//  ChangeDriverReasonsViewModel.swift
//  Quickride
//
//  Created by Rajesab on 23/10/21.
...
class ChangeDriverReasonsViewModel {
    ...
    func requestChangeDriver(driverChangeReason: String, taxiGroupId: Double, taxiRidePassengerId: Double, customerId: Double, status: String,complition: @escaping complitionHandler){
