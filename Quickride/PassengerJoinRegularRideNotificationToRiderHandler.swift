//
//  PassengerJoinRegularRideNotificationToRiderHandler.swift
//  Quickride
//
...
import Foundation
import ObjectMapper
class PassengerJoinRegularRideNotificationToRiderHandler: RideNotificationHandler{
    ...
    override func isNotificationQualifiedToDisplay(clientNotification: UserNotification, handler: @escaping (_ valid: Bool) -> Void)
    {
        super.isNotificationQualifiedToDisplay(clientNotification: clientNotification) { valid in
            ...
            guard let _ = MyRegularRidesCache.getInstance().getRegularRiderRide(riderRideId: riderRideId) else{
                return handler(false)
            }
            return handler(true)
        }
...
public class PassengerJoinedRegularRideNotificationToRiderDynamicData : NSObject, Mappable {
