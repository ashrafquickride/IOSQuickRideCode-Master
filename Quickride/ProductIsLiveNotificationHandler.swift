//
//  ProductIsLiveNotificationHandler.swift
//  Quickride
//
...
class ProductIsLiveNotificationHandler: NotificationHandler {
    ...
    override func handleTap(userNotification: UserNotification, viewController: UIViewController?) {
        self.handlePositiveAction(userNotification: userNotification, viewController: viewController)
        QuickShareNotificationHandler().getAndShowMyPostedProduct(userNotification: userNotification, viewController: viewController)
    }
}
