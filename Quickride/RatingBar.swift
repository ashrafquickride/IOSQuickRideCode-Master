...
import UIKit
//@IBDesignable 在视图中拖入控件可以看到渲染情况，结果出现以下错误，https://stackoverflow.com/questions/27374330/ibdesignable-error-ib-designables-failed-to-update-auto-layout-status-interf 这里也是一样情况，暂时无解
